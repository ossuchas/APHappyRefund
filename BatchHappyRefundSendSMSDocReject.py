...
def getDfltParam():
    ...
    WHERE param_code = 'CRM_SMSDOCREJT_REFUND'
    ORDER BY param_seqn
    """
...
def updateRefund(hyrf_id, send_status):
    ...
    SET sms_reject_doc_status = ?,
        sms_reject_doc_date = GETDATE()
    WHERE hyrf_id = ?
    """
...
if __name__ == '__main__':
    ...
    logFile = log_path + '/BatchHappyRefundSendSMSDocReject.log'
    
    APPNAME='BatchHappyRefundSendSMSDocReject'
    IPADDR=get_ipaddr()
